...
// Component Imports
import StepLokasi from './component/StepLokasi'
import StepAnggota from './component/StepAnggota'
import StepConfirmation from './component/StepConfirmation'
...
const getStepContent = (step, handleNext) => {
  switch (step) {
    case 0:
      return <StepLokasi handleNext={handleNext} />
    case 1:
      return <StepAnggota handleNext={handleNext} />
    case 2:
      return <StepConfirmation handleNext={handleNext} />
    default:
      return null
  }
}
